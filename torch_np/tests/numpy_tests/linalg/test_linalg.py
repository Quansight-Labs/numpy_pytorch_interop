...
from torch_np import array, single, double, csingle, cdouble, dot, identity, matmul
from torch_np import swapaxes
from torch_np import multiply, atleast_2d, inf, asarray
from torch_np import linalg
from torch_np.linalg import matrix_power, norm, matrix_rank, multi_dot, LinAlgError
